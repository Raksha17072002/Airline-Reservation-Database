...
<li><a href="pnr.php"><i class="fa fa-desktop" aria-hidden="true"></i> Print Ticket</a></li>
		...
		<table cellpadding="5">
			<tr>
				<td class="admin_func"><a href="book_tickets.php" style="color:black;"><i class="fa fa-plane" aria-hidden="true"></i> Book Flight Tickets</a>
				</td>
			</tr>
			<tr>
				<td class="admin_func"><a href="view_booked_tickets.php" style="color:black;"><i class="fa fa-plane" aria-hidden="true"></i> View Booked Flight Tickets</a>
				</td>
			</tr>
<tr>
				<td class="admin_func"><a href="pnr.php" style="color:black;"><i class="fa fa-plane" aria-hidden="true"></i> Print Booked Ticket</a>
				</td>
			</tr>
			<tr>
				<td class="admin_func"><a href="cancel_booked_tickets.php" style="color:black;"><i class="fa fa-plane" aria-hidden="true"></i> Cancel Booked Flight Tickets</a>
				</td>
			</tr>
		</table>
			</div>
